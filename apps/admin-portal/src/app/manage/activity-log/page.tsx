...
import { getHumanReadableMetadata, type ActivityActor, type ActivityLogEntry } from "@deskatlas/domain";
...
const ACTION_GROUPS: { label: string; value: string; types?: string[] }[] = [
  ...
  },
  {
    ...
    types: [
      ...
      "payment_review_reconsidered_approved",
      "payment_approved",
      "PAYMENT_APPROVED",
  ...
  },
  {
    label: "Map & Space",
    value: "MAP",
    types: ["map_published", "MAP_PUBLISHED", "map_draft_saved", "MAP_DRAFT_SAVED"],
  },
  {
...
export default function AdminActivityLogPage() {
  ...
  const fetchLogs = useCallback(async () => {
    ...
    try {
      ...
      if (selectedActor) {
        params.set("actorId", selectedActor);
      }
  ...
  }, [page, limit, selectedActor, selectedGroup, datePreset, fromDate, toDate]);
  ...
  const getRoleBadgeStyle = (role: string) => {
    ...
    if (r === "ADMIN" || r === "SUPERADMIN") {
      return { background: "#EBF3FE", color: "#1D4ED8", border: "1px solid #BFDBFE" };
    }
    if (r === "STAFF") {
  ...
  const getActionBadgeStyle = (action: string) => {
    ...
    if (act.includes("map") || act.includes("publish")) {
  ...
  return (
    <div style={{ padding: "28px", maxWidth: "1400px", margin: "0 auto", width: "100%", fontFamily: "var(--da-font-family)" }}>
      {/* HEADER */}
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ fontSize: "14px", color: "var(--da-text-secondary)", marginTop: "4px", marginBottom: 0 }}>
          Comprehensive chronological record of all administrative and operational activities.
        </p>
      </div>
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "13px" }}>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={5} style={{ padding: "48px 20px", textAlign: "center", color: "var(--da-text-secondary)" }}>
                    ...
                    <div style={{ marginTop: "10px", fontSize: "13px" }}>Loading activity log records...</div>
                  </td>
                </tr>
              ) : entries.length === 0 ? (
                <tr>
                  <td colSpan={5} style={{ padding: "48px 20px", textAlign: "center", color: "var(--da-text-secondary)" }}>
                    ...
                    <div style={{ fontSize: "13px" }}>
                      There are no audit logs matching your current filters.
                    </div>
                  </td>
                </tr>
              ) : (
                entries.map((entry) => {
                  const roleStyle = getRoleBadgeStyle(entry.actorRole);
          ...
          >
            ...
            <div style={{ padding: "20px 24px", overflowY: "auto", display: "flex", flexDirection: "column", gap: "16px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", background: "var(--da-canvas)", padding: "14px", borderRadius: "8px" }}>
                <div>
                  <div style={{ fontSize: "11px", color: "var(--da-text-secondary)", fontWeight: 700 }}>ACTOR</div>
                  <div style={{ fontSize: "13px", fontWeight: 600, color: "var(--da-text-primary)", marginTop: "2px" }}>
                    {selectedEntryForDetails.actorName} ({selectedEntryForDetails.actorRole})
                  </div>
                </div>
                <div>
